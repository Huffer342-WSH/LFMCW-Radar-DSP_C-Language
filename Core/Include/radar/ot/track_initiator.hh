...
public:
        ...
        , missed_distance(missed_distance)
    {
        ...
        motion_score = (int32_t)(score / this->time2init_motion);
        static_score = (int32_t)(score / this->time2init_static);
        for (int i = 0; i < 4; ++i) {
        ...
        RD_DEBUG("unassociated_time: %f\nkeep_motion_time: %f\nkeep_static_time: %f\nspeed_threshold: %f\nmissed_distance: %f\n"
                 ...
                 unassociated_time, time2init_motion, time2init_static, speed_threshold, missed_distance, unassociated_score, motion_score, static_score);
